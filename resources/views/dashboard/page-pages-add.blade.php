            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-check form-switch p-0">
                        <label for="debugbar"><strong>Make this page as Homepage</strong></label>
                        <br>
                        @if(!optional($homepage)->option_value)
                            <input id="debugbar" class="form-check-input" type="checkbox" name="homepage_id" style="cursor: pointer;">
                        @else
                            <div class="alert alert-danger alert-dismissible fade show" role="alert" style="box-shadow: none; background-color: #fff1f2;">
                                {!! __('This page can\'t be set as the Homepage because a different page is currently selected. <a href="' . route('dash.pages.edit', optional($homepage)->option_value) . '" title="Edit The Homepage">Edit The Hompage</a>.') !!}
                            </div>
                        @endif
                    </div>
                </div>
