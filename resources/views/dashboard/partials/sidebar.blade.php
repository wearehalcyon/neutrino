        ...
        <div class="sidebar-content">
            <ul class="nav nav-secondary">
                ...
                @if(hideAccess([3,4,5]))
                    ...
                    <li class="nav-item @if(in_array($routeName, ['dash.categories', 'dash.categories.add', 'dash.categories.edit', 'dash.tags', 'dash.tags.add', 'dash.tags.edit', 'dash.posts', 'dash.posts.add'])){{ __('submenu active') }}@endif">
                        <a data-bs-toggle="collapse" href="#blog" class="@if(in_array($routeName, ['dash.categories', 'dash.categories.add', 'dash.categories.edit', 'dash.tags', 'dash.tags.add', 'dash.tags.edit', 'dash.posts', 'dash.posts.add'])){{ __('active') }}@endif" aria-expanded="false">
                            <i class="fas fa-file-alt"></i>
                            <p>{{ __('Blog') }}</p>
                            <span class="caret"></span>
                        </a>
                        <div class="collapse @if(in_array($routeName, ['dash.categories', 'dash.categories.add', 'dash.categories.edit', 'dash.tags', 'dash.tags.add', 'dash.tags.edit', 'dash.posts', 'dash.posts.add'])){{ __('show') }}@endif" id="blog">
                            <ul class="nav nav-collapse">
                                <li class="@if(in_array($routeName, ['dash.posts', 'dash.posts.add'])){{ __('active') }}@endif">
